<script>
  ...
  import studioM1 from '$lib/img/m1.jpg?run'
  import studioM2 from '$lib/img/m2.jpg?run'
  import studioS1 from '$lib/img/s1.jpg?run'
  import studioS2 from '$lib/img/s2.jpg?run'
  import car from '$lib/img/car.jpg?run'
